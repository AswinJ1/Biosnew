    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="inline-flex items-center px-3 py-1 mb-4 text-xs font-medium text-cyber-green bg-cyber-green/10 rounded-full">
            ...
            <span className="typing-animation blink text-lg">who we are ?</span>
          </div>
          {/* <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Our Identity</h2> */}
          <p className="text-foreground/80 mb-8 max-w-2xl mx-auto text-justify">
            Founded in 2007, Team bi0s is India’s oldest and most accomplished student-run CTF team. 
            With over 60 active members and alumni at leading global security firms, we’ve built a thriving community rooted in excellence and innovation. 
            For the past 9 consecutive years, bi0s has held the title of India’s No.1 ranking cybersecurity team, earning international acclaim through consistent top performances and groundbreaking research.
          </p>
        </div>
